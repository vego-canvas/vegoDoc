<template>
    <div class="main row">
        <a href="https://github.com/vego-canvas/vego" class="github-corner" aria-label="View source on GitHub">
            <svg width="80" height="80" viewBox="0 0 250 250" :style="`fill:#151513; color:#fff; position: absolute; top: ${ismobile?'68px':0}; border: 0; right: 0;`" aria-hidden="true">
        ...
        <nav class="sm-12 lg-3 col sidebar" v-if="!ismobile">
            <h1>Vego</h1>
        ...
        <div class="sm-12 lg-9 col main"><router-view></router-view></div>
    </div>
</template>
